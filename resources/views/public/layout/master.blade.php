...
<body>
	...
	<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-TQ2T2H9"
        ...
        <div class="carousel_best_buy owl-carousel owl-theme" style="padding: 20px 0; background: rgb(220, 220, 220);">
          ...
          <div class="item">
            <div class="item-img">
              ...
              <p style="display:block; position:absolute;top:50%;" class="full left text-center" >
                <span class="item-addCart btn btn-default btn-lg text-uppercase" onclick="muangay('c1e9290618102459696','1','1');">
                  <i class="fa fa-shopping-cart"></i>Mua ngay
                </span>
              </p>
            </div>
          ...
          <div class="item">
            <div class="item-img">
              ...
              <p style="display:block; position:absolute;top:50%;" class="full left text-center" >
                <span class="item-addCart btn btn-default btn-lg text-uppercase" onclick="muangay('eb91230418180811629','1','1');">
                  <i class="fa fa-shopping-cart"></i>Mua ngay
                </span>
              </p>
            </div>
      ...
      <div class="product product-home product-wrapper">
        ...
        <div class="item-wrapper">
          <div class="item">
            ...
            <div class="item-name">
              <a href="ga-bo-xoi-2-mau-om-trung-hat-sen-�%2580%2593-vi-tieu-xanh-spdetail-eb91230418180811629.html">
                <h2 class="text-center text-uppercase distance-none" title="G&#192; B&#211; X&#212;I 2 M&#192;U &#212;M TRỨNG HẠT SEN – VỊ TI&#202;U XANH">G&#192; B&#211; X&#212;I 2 M&#192;U &#212;M TRỨNG HẠT SEN – VỊ TI&#202;U XANH</h2>
              </a>
              <div class="price text-center">
                <span>430.000 đ</span>
              </div>
